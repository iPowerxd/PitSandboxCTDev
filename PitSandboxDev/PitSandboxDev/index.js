...
register("renderOverlay", () => {
    ...
    if (perks[0][1] != "Nothing") info.splice(3, 0, "&c" + (perks[0][1] == "Nothing" ? "" : perks[0][1] + "&7 " + perks[0][1]))
    if (perks[0][2] != "Nothing") info.splice(4, 0, "&c" + (perks[0][2] == "Nothing" ? "" : perks[0][2] + "&7 " + perks[0][2]))
