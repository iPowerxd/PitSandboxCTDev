...
register("renderOverlay", () => {
    ...
    info.splice(4, 0, "&c" + (perks[0][2][0] == "Nothing" ? "" : perks[0][2][0] + "&e " + perks[0][2][1]))
    info.splice(5, 0, "")
    info.splice(6, 0, "&6" + (perks[1][0] == "Nothing" ? "" : perks[1][0]))
    info.splice(7, 0, "&6" + (perks[1][1] == "Nothing" ? "" : perks[1][1]))
    info.splice(8, 0, "&6" + (perks[1][2] == "Nothing" ? "" : perks[1][2]))
    let y = 80
    info.forEach(line => {
